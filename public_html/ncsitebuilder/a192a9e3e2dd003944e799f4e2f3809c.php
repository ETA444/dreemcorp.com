...
<head>
	...
	<title><?php echo htmlspecialchars((isset($seoTitle) && $seoTitle !== "") ? $seoTitle : "DREEMCORP — Creative Agency & Media Production"); ?></title>
	<base href="{{base_url}}" />
	<?php echo isset($sitemapUrls) ? (generateCanonicalUrl($sitemapUrls)."\n") : ""; ?>	
	
			<meta name="description" content="<?php echo htmlspecialchars((isset($seoDescription) && $seoDescription !== "") ? $seoDescription : "DREEMCORP is a creative agency specializing in video editing, social media content, personal branding, and visual production."); ?>" />
			<meta name="keywords" content="<?php echo htmlspecialchars((isset($seoKeywords) && $seoKeywords !== "") ? $seoKeywords : "creative agency,video editing,social media content,personal branding,content creation,short form video,long form editing,color correction,brand identity,visual production,reels editing,tiktok content,youtube branding,dreemcorp"); ?>" />
				<meta property="og:site_name" content="DREEMCORP — Creative Agency & Media Production">
	
	<!-- Facebook Open Graph -->
			<meta property="og:description" content="<?php echo htmlspecialchars((isset($seoDescription) && $seoDescription !== "") ? $seoDescription : "DREEMCORP is a creative agency specializing in video editing, social media content, personal branding, and visual production."); ?>" />
					<!-- Facebook Open Graph end -->

		<meta name="generator" content="Website Builder" />
			<script src="js/common-bundle.js?ts=20260509125333" type="text/javascript"></script>
	<script src="js/a192a9e3e2dd003944e799f4e2f3809c-bundle.js?ts=20260509125333" type="text/javascript"></script>
	...
	<link href="css/a192a9e3e2dd003944e799f4e2f3809c-bundle.css?ts=20260509125333" rel="stylesheet" type="text/css" id="wb-page-stylesheet" />
